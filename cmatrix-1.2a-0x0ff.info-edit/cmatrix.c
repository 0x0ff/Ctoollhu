 ...
 *                                                                        *
 *   CHANGES                                                              *
 *   - logfile supervision added by www.0x0ff.info                        *
 **************************************************************************/
...
void usage(void)
{
	...
	/*=======www.0x0ff.info=======*/
	printf(" -L: connect to a log file\n");
	/*=======www.0x0ff.info=======*/
...
int main(int argc, char *argv[])
{
	...
	/*=======www.0x0ff.info=======*/
	int filesize=0, sizetemp=0, logfile=0;
	FILE * file;
	char *filename;
	/*=======www.0x0ff.info=======*/
    ...
    opterr = 0;
    while ((optchr = getopt(argc, argv, "abBfhlL:nosxVu:C:")) != EOF) {
	switch (optchr) {
	case 's':
	    screensaver = 1;
	    break;
